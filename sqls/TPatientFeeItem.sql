...
DROP TABLE IF EXISTS t_patient_fee_item;
CREATE TABLE t_patient_fee_item(
	...
	patient_meal_id BIGINT (15) DEFAULT -1 COMMENT 'patientMealId',
	...
	PRIMARY KEY (id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 't_patient_fee_item';
