...
CREATE TABLE [dbo].[t_bill_info] (
  ...
  [create_user] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  ...
  [patient_id] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [patient_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [patient_id_card_no] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
...
CREATE TABLE [dbo].[t_bill_items_info] (
  ...
  [create_date] datetime2(7)  NULL,
  [update_date] datetime2(7)  NULL,
  [bill_id] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [order_no] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [sub_bill_id] bigint  NULL,
  [sub_order_no] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [item_id] bigint  NULL,
  [item_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [item_price] decimal(13,4)  NULL,
  [num] decimal(13,4)  NULL,
  [total_price] decimal(13,4)  NULL
)
GO
...
CREATE TABLE [dbo].[t_bill_log] (
  ...
  [patient_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [patient_id] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [current_total_price] decimal(13,4)  NULL,
  [previous_total_price] decimal(13,4)  NULL,
...
CREATE TABLE [dbo].[t_check_department_items] (
  ...
  [code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [check_item_id] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL
)
GO
...
CREATE TABLE [dbo].[t_check_item] (
  ...
  [code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [lowest_value] decimal(13,4)  NULL,
  [highest_value] decimal(13,4)  NULL,
  [yin_yang] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [lis_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL
)
GO
...
CREATE TABLE [dbo].[t_customer_contract] (
  ...
  [signing_time] datetime2(7)  NULL,
  [status] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [file_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [bukect_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL
)
GO
...
CREATE TABLE [dbo].[t_customer_order] (
  ...
  [total_amount] decimal(13,4)  NULL,
  [status] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL
)
GO
...
CREATE TABLE [dbo].[t_fee_item] (
  ...
  [dis_price] decimal(13,4)  NULL,
  [market_price] decimal(13,4)  NULL,
  [type] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
...
CREATE TABLE [dbo].[t_patient] (
  ...
  [update_date] datetime2(7)  NULL,
  [team_id] bigint  NULL,
  [team_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [team_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  ...
  [age] int  NULL,
  [sex] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [marriage] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [bear] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
...
CREATE TABLE [dbo].[t_patient_check_item] (
  ...
  [fee_item_id] bigint  NULL,
  [check_item_id] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [check_item_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [check_item_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [meal_id] bigint  NULL,
...
CREATE TABLE [dbo].[t_patient_fee_item] (
  ...
  [patient_id] bigint  NULL,
  [fee_item_id] bigint  NULL,
  [fee_item_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [fee_item_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [meal_id] bigint  NULL,
...
CREATE TABLE [dbo].[t_patient_group] (
  ...
  [meal_id] bigint  NULL,
  [meal_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [person_num] int  NULL
)
GO
...
CREATE TABLE [dbo].[t_patient_meal] (
  ...
  [team_id] bigint  NULL,
  [group_id] bigint  NULL,
  [meal_type] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [meal_source] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [meal_id] bigint  NULL,
  [team_meal_id] bigint  NULL,
  [meal_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [meal_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [price] decimal(13,4)  NULL,
  [dis_price] decimal(13,4)  NULL,
  [market_price] decimal(13,4)  NULL
...
CREATE TABLE [dbo].[t_personal_report_check_items] (
  ...
  [check_item_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [result_type] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [lower_limit] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [upper_limit] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [detection_value] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [conclusion] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL
)
GO
...
CREATE TABLE [dbo].[t_personal_report_info] (
  ...
  [patient_id] bigint  NULL,
  [patient_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [patient_id_number] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [patient_phone] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [file_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [bucket_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
...
CREATE TABLE [dbo].[t_sales_record] (
  ...
  [seller_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [customer_id] bigint  NULL,
  [customer_code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
  [customer_name] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS  NULL,
