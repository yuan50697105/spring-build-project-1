package org.example.spring.repositories.clients.dubbo.commons.api;
...
public interface CommonsDubboRepository<T extends ICommonsEntity, V extends T, D extends T, Q extends ICommonsQuery> {
