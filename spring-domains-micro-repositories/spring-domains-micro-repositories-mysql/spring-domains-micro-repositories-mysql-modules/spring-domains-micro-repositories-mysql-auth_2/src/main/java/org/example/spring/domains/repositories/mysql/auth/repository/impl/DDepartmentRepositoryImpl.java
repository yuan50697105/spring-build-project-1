...
@Transactional
@Primary
public class DDepartmentRepositoryImpl extends TDepartment2RepositoryImpl implements DDepartmentRepository {
    ...
    public DDepartmentRepositoryImpl(TDepartmentDao departmentDao, TDepartmentRoleDao departmentRoleDao, TDepartmentBuilder departmentBuilder, TDepartmentRoleBuilder departmentRoleBuilder, TRole2Repository role2Repository) {
