package org.example.spring.daos.postgresql.auth.dao.impl;

import com.baomidou.mybatisplus.core.conditions.Wrapper;
import lombok.AllArgsConstructor;
import org.example.spring.daos.postgresql.auth.builder.AuthBuilder;
import org.example.spring.daos.postgresql.auth.dao.TRoleResourceDao;
import org.example.spring.daos.postgresql.auth.mapper.TRoleResourceMapper;
import org.example.spring.daos.postgresql.auth.table.po.TResource;
import org.example.spring.daos.postgresql.auth.table.po.TRoleResource;
import org.example.spring.daos.postgresql.auth.table.query.TRolePermissionQuery;
