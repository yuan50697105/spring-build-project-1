package org.example.spring.repositories.es.patient.entity.po;
 ...
 */
@ApiModel(value = "org-example-spring-daos-mysql-patient-table-po-TPatientTeamMealCheckItem")
@Data
@EqualsAndHashCode(callSuper = true)
@AllArgsConstructor
@NoArgsConstructor
public class EPatientTeamMealCheckItem extends IBaseEntity implements Serializable {
