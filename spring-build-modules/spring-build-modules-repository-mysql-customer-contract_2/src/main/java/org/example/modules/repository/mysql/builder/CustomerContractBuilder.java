...
public interface CustomerContractBuilder {
    ...
    CustomerContractVo createCustomerContractVo(TCustomerContract customerContract);

    TCustomerContractQuery createCustomerContractQuery(CustomerContractQuery customerContractQuery);

    List<CustomerContractVo> createCustomerContractVos(List<TCustomerContract> contracts);

    IPageData<CustomerContractVo> createCustomerContractVos(IPageData<TCustomerContract> data);
}
