package org.example.spring.repositories.postgres.items.table.query;
 ...
 * t_meal_fee_item
 */
@ApiModel(value = "org-example-spring-infrastructures-postgres-items-table-po-TMealFeeItem")
@Data
