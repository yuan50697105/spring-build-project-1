...
import org.example.spring.daos.postgres.auth.dao.TRoleResourceDao;
import org.example.spring.daos.postgres.auth.mapper.TRoleResourceMapper;
import org.example.spring.daos.postgres.auth.table.po.TResource;
import org.example.spring.daos.postgres.auth.table.po.TRoleResource;
import org.example.spring.daos.postgres.auth.table.query.TRolePermissionQuery;
