...
import org.example.spring.daos.postgres.auth.dao.TUserRoleDao;
import org.example.spring.daos.postgres.auth.mapper.TUserRoleMapper;
import org.example.spring.daos.postgres.auth.table.po.TRole;
import org.example.spring.daos.postgres.auth.table.po.TUserRole;
import org.example.spring.daos.postgres.auth.table.query.TUserRoleQuery;
