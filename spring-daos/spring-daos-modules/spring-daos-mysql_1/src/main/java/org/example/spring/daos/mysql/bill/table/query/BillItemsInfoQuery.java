...
@Data
public class BillItemsInfoQuery extends TkExtQuery<BillItemsInfo> implements MybatisExampleForTk<BillItemsInfo, Example> {
    @AndEqualTo
    ...
    @Override
    public Wrapper<BillItemsInfo> wrapper() {
