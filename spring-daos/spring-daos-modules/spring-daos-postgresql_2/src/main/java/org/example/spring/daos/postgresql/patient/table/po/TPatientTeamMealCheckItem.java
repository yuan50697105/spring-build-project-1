package org.example.spring.daos.postgresql.patient.table.po;
...
@ApiModel(value = "org-example-spring-daos-postgresql-patient-table-po-TPatientTeamMealCheckItem")
@Data
